...
<template>
	...
	<svg ref="commercialSignatureFirst" class="commercial-signature-first" viewBox="0 0 384 425" fill="none" xmlns="http://www.w3.org/2000/svg">
